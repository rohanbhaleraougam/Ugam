 ...
 * under the License.
 ******************************************************************************/
package org.apache.sling.scripting.sightly.apps.ugamdemo.components.content.portfolio__002d__teaser;
...
out.write("    <section class=\"portfolio-area section-gap col-lg-12\" id=\"portfolio\">\t\n");
_global_portfolio = renderContext.call("use", com.ugamdemo.core.models.Portfolio.class.getName(), obj());
...
{
    Object var_attrvalue8 = renderContext.getObjectModel().resolveProperty(_global_portfolio, "preimg");
    {
...
out.write(" alt=\"\"/></div>\n\t\t\t\t\t\t\t\t\t  </div>\n\t\t\t\t\t\t\t\t</a>                              \t\t\n                            \t</div>\n\t\t\t\t\t\t\t\t<div class=\"p-inner\">\n\t\t\t\t\t\t\t\t    <h4>");
{
    Object var_12 = renderContext.call("xss", renderContext.getObjectModel().resolveProperty(_global_portfolio, "portfolioTitle"), "text");
    out.write(renderContext.getObjectModel().toString(var_12));
}
out.write("</h4>\n\t\t\t\t\t\t\t\t\t<div class=\"cat\">");
{
    Object var_13 = renderContext.call("xss", renderContext.getObjectModel().resolveProperty(_global_portfolio, "portfolioText"), "text");
